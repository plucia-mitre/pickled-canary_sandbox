	...
	static final String expected2 = """
{
	...
	public void testLaunch() throws InterruptedException {
		...
		GhidraThreadedTablePanel<SavedDataAddresses> filterTable = (GhidraThreadedTablePanel<SavedDataAddresses>) getInstanceField("filterTable", provider);
		...
		// We're going to reset our output (manually) so we can tell when we're done with our next pattern
		compiledTextArea.setText("Compiling Pattern...");
		
		// No compile another pattern to make sure PCVisitor was reset (at least the basics were reset).
		// TODO: Make this pattern more complex so we're checking that more state was reset properly.
